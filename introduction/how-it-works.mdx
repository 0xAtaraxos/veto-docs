...
Every token on veto.fun lives the same on-chain life. No special cases, no admin shortcuts, no "trust us". The rules below are enforced by the contracts for every launch, including ours.
