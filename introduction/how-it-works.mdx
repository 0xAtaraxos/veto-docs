...
description: "The full lifecycle of a token on veto.fun: from launch, through bonding-curve trading, to graduation into a locked Uniswap v3 pool."
icon: "diagram-project"
---

Every token on veto.fun goes through the same transparent, on-chain lifecycle. There are no special cases and no admin shortcuts. The rules below are enforced by the smart contracts for every launch.
