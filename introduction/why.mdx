...
**50% of every fee the launchpad earns buys back [$MAKI](/introduction/maki-token) on the open market.** The protocol doesn't extract from the ecosystem and leave; half of everything flows back in. The token wins exactly when the platform does.
