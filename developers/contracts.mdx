...
description: "The maki.finance smart contracts (VetoDotFun, VetoCurveToken, and FeeLocker): functions, events, and errors."
icon: "file-contract"
---
...
Live on Robinhood Chain mainnet (4663) since block 12,262,096, source-verified on Blockscout:
