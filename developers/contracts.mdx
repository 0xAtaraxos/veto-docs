...
description: "The hoodstar.fun smart contracts (HoodstarDotFun, HoodToken, and FeeLocker): functions, events, and errors."
icon: "file-contract"
---

Three contracts (Solidity 0.8.30, OpenZeppelin-based) run the entire protocol. Integrators only need the **HoodstarDotFun** address. Everything else is discoverable from it.
