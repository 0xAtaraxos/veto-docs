...
description: "Build bots, indexers, and frontends on veto.fun with @vetostudio/veto-sdk: typed reads and writes, exact quote math, and event streaming."
icon: "js"
---

`@vetostudio/veto-sdk` is the official TypeScript SDK for the veto.fun protocol. It's a thin, fully-typed layer over [viem](https://viem.sh) (its only peer dependency) covering the entire protocol surface: launching tokens, trading the curve, quoting, migration, fee claims, and event streaming.
