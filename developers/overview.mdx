...
```mermaid
flowchart LR
    Creator -- "createToken()" --> LP[HoodstarDotFun]
    Trader -- "buy / sell" --> LP
...
| Contract | Role |
| --- | --- |
| **HoodstarDotFun** | Singleton: token factory, all bonding curves, fee ledger, and Uniswap migrator in one contract. |
...
| --- | --- |
| HoodstarDotFun | [`0x152172137fa870a51DFde25a0dFc0bE9ad4dEE5A`](https://robinhoodchain.blockscout.com/address/0x152172137fa870a51DFde25a0dFc0bE9ad4dEE5A) |
