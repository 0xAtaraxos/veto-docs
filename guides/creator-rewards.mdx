...
<Note>
  Claims are **pull-based and permissionless at the contract level**: the claim function can be triggered by anyone, but the money only ever goes to the registered fee recipient, which is you. That means a helpful bot (or the platform) can claim on your behalf without ever being able to take your fees.
</Note>
