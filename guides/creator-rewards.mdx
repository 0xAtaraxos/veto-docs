...
description: "How creators earn on veto.fun: 0.3% of every curve trade and 30% of Uniswap fees after graduation, forever."
icon: "gift"
---

Launching a token on veto.fun gives you a permanent, on-chain fee stream. Not an airdrop, not an allocation you have to dump: a revenue share that pays as long as your coin trades. There are two phases.
