---
title: "Trading"
description: "How buying and selling works on maki.finance, on the bonding curve and after graduation on Uniswap v3."
icon: "chart-line-up"
---

{/* Capture: a token page with chart + trade widget. Drop at /images/trading.png and uncomment:
<Frame caption="A curve-phase token: live chart, trades, and the progress bar to graduation.">
...
- **On the curve:** your trade goes to the maki.finance bonding curve contract.
