...
description: "Create your own meme coin on veto.fun in one transaction, for a flat 0.001 ETH."
icon: "rocket"
---

Launching on veto.fun takes one transaction and costs a flat 0.001 ETH plus gas.
