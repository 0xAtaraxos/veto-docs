...
| Power | Bound |
| --- | --- |
| Tune the global fee config | Hard caps in the contract (≤5% trade fee, ≤0.1 ETH creation fee); affects **future launches only** — every existing token keeps the fee snapshot taken at its creation, forever |
