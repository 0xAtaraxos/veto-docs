...
description: "The exact math behind maki.finance pricing: constant-product curve, virtual reserves, and graduation numbers."
icon: "function"
---

Every maki.finance token trades on the same **constant-product bonding curve** until it graduates. The curve is an automated market maker with no order book: price is purely a function of reserve state, so it's fully deterministic and quotable in advance.
