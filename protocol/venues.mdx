...
A veto.fun token doesn't trade on veto.fun. It trades on **Uniswap v3 on Arc**, in a **USDC/token pool on the 1% fee tier**, from its very first block.
...
All launch pools use the **1% tier** (tick spacing 200). The fee doesn't go to the DEX or to us off the top: it accrues to the locked position and is split creator/protocol as described in [fees](/protocol/fees).
